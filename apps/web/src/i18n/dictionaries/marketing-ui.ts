  ...
  sv: {
    ...
    search: {
      ...
      items: [
        ...
        { label: "Roots Premiumpaket", href: "/produkter/paket", category: "products" },
    ...
    calculator: {
      ...
      quickPick: "Snabbval",
      currencySuffix: "kr",
      packsApprox: "≈ {n} Premiumpaket à 399 kr",
  ...
  en: {
    ...
    search: {
      ...
      items: [
        ...
        { label: "Roots Conditioner", href: "/produkter/conditioner", category: "products" },
        { label: "Roots Body Wash", href: "/produkter/body-wash", category: "products" },
        { label: "Roots Premium pack", href: "/produkter/paket", category: "products" },
    ...
    calculator: {
      ...
      currencySuffix: "SEK",
      packsApprox: "≈ {n} premium packs at SEK 399",
