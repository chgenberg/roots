...
// P3.81 (audit 2026-05-26): scale-transformerna och pulse-ringen ignorerade
// prefers-reduced-motion. WCAG 2.3.3. motion-safe:* gör att animeringen bara
// körs när användarens OS tillåter rörelse.
const PRIMARY_CLASS =
  ...
  return (
    <div className="mt-5 flex flex-col gap-3 sm:flex-row sm:items-center">
      {HAIR_ANALYSIS_ENABLED ? (
        ...
        // Utan håranalysen finns ingen primär åtgärd kvar, och en hjälte-
        // sektion med bara en svag textlänk ser trasig ut. Produktlänken
        // får därför bära den vita knappen så länge.
        <Link href="/produkter" className={PRIMARY_CLASS}>
          <span className="absolute inset-0 rounded-full shadow-[0_0_0_0_rgba(255,255,255,0.3)] motion-safe:animate-[pulse-shadow-light_2.5s_ease-in-out_infinite]" />
          <span className="relative">Se produkterna</span>
          <ArrowRight className="relative h-3.5 w-3.5 transition-transform duration-300 motion-safe:group-hover:translate-x-0.5" />
        </Link>
      )}
    </div>
