    ...
    <div className="mt-5 flex flex-col gap-3 sm:flex-row sm:items-center">
      <HairAnalysisLeadDialog
        trigger={
          <button
            type="button"
            className="group relative inline-flex h-11 cursor-pointer items-center gap-2 rounded-full bg-white px-6 text-sm font-semibold text-foreground transition-transform duration-300 hover:scale-[1.03] active:scale-[0.98]"
          >
